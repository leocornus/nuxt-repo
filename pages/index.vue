...
v-container(grid-list-md text-center)
  v-list
    v-list-item
      a(href="https://covid19.leocorn.com") COVID-19 Cases Live Site (https:/covid19.leocorn.com)
    v-list-item
    ...
    v-list-item
      a(href="/javascript-sandbox") Some of my old work around JavaScript: JQuery, D3, etc.
    v-list-item
